// function Card(props) {
   function Card(
     { dressName  = "Unavailable",
     
       image
      = "https://images.pexels.com/photos/19877105/pexels-photo-19877105/free-photo-of-mong-c.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"}
   ) {
     return (
       <div class="flex font-serif bg-white mx-2 my-2">
